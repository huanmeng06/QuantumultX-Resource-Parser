  ...
  if ($resource.type == "server") { // server content
    ...
    sections: [
      ...
      },
      {
        type: "group",
        title: "🧩 QX 自定义增强",
        description: "默认关闭；开启 qxf=1 可一次启用清理、自动地区 Emoji、机场前缀和地区排序。",
        items: [
          { type: "switch", key: "qxf", label: "一键启用 QX 自定义清洗",
            onValue: "1", offValue: "",
            description: "等价于 clean=1&cleantag=1&autoe=1&airport=1&rsort=1" },
          { type: "switch", key: "clean", label: "删除订阅说明/流量/官网/群组等伪节点",
            onValue: "1", offValue: "" },
          { type: "switch", key: "cleantag", label: "清理节点名特殊符号",
            onValue: "1", offValue: "" },
          { type: "switch", key: "autoe", label: "自动识别地区 Emoji",
            onValue: "1", offValue: "" },
          { type: "switch", key: "airport", label: "插入机场名前缀",
            onValue: "1", offValue: "",
            description: "使用 QX 资源标签作为 [机场名]，插入到 Emoji 之后" },
          { type: "switch", key: "rsort", label: "按地区顺序排序",
            onValue: "1", offValue: "",
            description: "默认顺序：香港、日本、新加坡、台湾、中国、美国，其余沉底" }
        ]
      },
      {
        type: "group",
...
// ==== QX 自定义节点清洗/命名增强（融合版）====
// 用法：#qxf=1 一键启用；或拆分使用 clean=1&cleantag=1&autoe=1&airport=1&rsort=1
// 注意：台湾相关关键词在本自定义增强中统一输出 🇨🇳。
